# -*- encoding: utf-8 -*-
# stub: chaos_detector 0.4.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = ["bin/detect_chaos".freeze, "lib/chaos_detector.rb".freeze, "lib/chaos_detector/atlas.rb".freeze, "lib/chaos_detector/atlas_metrics.rb".freeze, "lib/chaos_detector/chaos_graphs/chaos_graph.rb".freeze, "lib/chaos_detector/chaos_graphs/domain_metrics.rb".freeze, "lib/chaos_detector/chaos_graphs/domain_node.rb".freeze, "lib/chaos_detector/chaos_graphs/function_node.rb".freeze, "lib/chaos_detector/chaos_graphs/mod_info.rb".freeze, "lib/chaos_detector/chaos_graphs/module_node.rb".freeze, "lib/chaos_detector/grapher.rb".freeze, "lib/chaos_detector/navigator.rb".freeze, "lib/chaos_detector/options.rb".freeze, "lib/chaos_detector/stacker/frame.rb".freeze, "lib/chaos_detector/stacker/frame_stack.rb".freeze, "lib/chaos_detector/walkman.rb".freeze, "lib/graph_theory/appraiser.rb".freeze, "lib/graph_theory/edge.rb".freeze, "lib/graph_theory/graph.rb".freeze, "lib/graph_theory/node.rb".freeze, "lib/graph_theory/node_metrics.rb".freeze, "lib/tcs/refined_utils.rb".freeze, "lib/tcs/utils/core_util.rb".freeze, "lib/tcs/utils/fs_util.rb".freeze, "lib/tcs/utils/log_util.rb".freeze, "lib/tcs/utils/str_util.rb".freeze]
