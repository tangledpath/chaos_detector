...
Gem::Specification.new do |s|
  ...
  s.files = ["bin/detect_chaos".freeze, "lib/chaos_detector.rb".freeze, "lib/chaos_detector/atlas.rb".freeze, "lib/chaos_detector/atlas_metrics.rb".freeze, "lib/chaos_detector/chaos_graphs/chaos_graph.rb".freeze, "lib/chaos_detector/chaos_graphs/domain_metrics.rb".freeze, "lib/chaos_detector/chaos_graphs/domain_node.rb".freeze, "lib/chaos_detector/chaos_graphs/fn_info.rb".freeze, "lib/chaos_detector/chaos_graphs/function_node.rb".freeze, "lib/chaos_detector/chaos_graphs/mod_info.rb".freeze, "lib/chaos_detector/chaos_graphs/module_node.rb".freeze, "lib/chaos_detector/graphing/directed.rb".freeze, "lib/chaos_detector/graphing/graphs.rb".freeze, "lib/chaos_detector/navigator.rb".freeze, "lib/chaos_detector/options.rb".freeze, "lib/chaos_detector/stacker/frame.rb".freeze, "lib/chaos_detector/stacker/frame_stack.rb".freeze, "lib/chaos_detector/walkman.rb".freeze, "lib/chaos_detector/graph_theory/appraiser.rb".freeze, "lib/chaos_detector/graph_theory/edge.rb".freeze, "lib/chaos_detector/graph_theory/graph.rb".freeze, "lib/chaos_detector/graph_theory/node.rb".freeze, "lib/chaos_detector/graph_theory/node_metrics.rb".freeze, "lib/chaos_detector/refined_utils.rb".freeze, "lib/chaos_detector/utils/core_util.rb".freeze, "lib/chaos_detector/utils/fs_util.rb".freeze, "lib/chaos_detector/utils/log_util.rb".freeze, "lib/chaos_detector/utils/str_util.rb".freeze]
